...
In dieser Arbeit sind die grundlegenden Eigenschaften und der Aufbau des CF-Schedulers dargestellt. Es wird gezeigt, dass der CF-Scheduler mit Hilfe bestimmter Algorithmen und Prinzipien versucht, immer eine faire Verteilung unter den aufzuführenden Prozessen zu erreichen. Außerdem soll dabei auch weiterhin eine annähernde Multi-Task Umgebung beibehalten werden. Ein Vergleich zum O(1) Scheduler zeigt im Bereich des Interaktiven X-Window Server ein deutliche Verbesserung der Latenzzeit.
...
Es ist zu sehen, dass noch einige Anforderungen an den Scheduler offen sind.
