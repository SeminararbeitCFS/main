...
Bei \textit{nice}-Wert 0 ergäbe es nach Einsetzten in Formel (\ref{eq:vruntime}) des bereits oben berechneten \textit{slice}-Wertes von $8.2ms$ für \textit{delta\_exec}, dem ermittelten Gewicht von $1024$ für \textit{se$\rightarrow$load.weight} und 1024 für $NICE\_0\_LOAD$  einen Wert von $8,2ms$.
